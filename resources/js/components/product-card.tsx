  ...
  return (
    <div className="group flex flex-col overflow-hidden rounded-xl border border-border bg-white transition hover:-translate-y-1 hover:shadow-[var(--shadow-card)]">
      ...
      <div className="flex flex-1 flex-col p-3 sm:p-4">
        <div className="text-[11px] font-semibold uppercase tracking-wider text-text-muted">{segment}</div>
        ...
        <div className="mt-auto pt-4">
          <div>
            ...
            <div className="font-display text-lg font-black leading-none text-navy sm:text-xl">{price}</div>
          </div>
