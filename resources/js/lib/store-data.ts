...
export const products: Product[] = [
  {
    ...
    category: "Calças",
    segment: "Empresarial",
    description: "Peça resistente para rotina operacional, com conforto e ótimo acabamento.",
    price: 69.9,
  ...
  },
  {
    ...
    description: "Proteção, durabilidade e apresentação profissional para equipes.",
    price: 89.9,
  ...
  },
  {
    ...
    category: "Camisetas",
    segment: "Empresarial",
    description: "Camiseta leve e versátil para equipes, eventos e atendimento.",
    price: 59.9,
