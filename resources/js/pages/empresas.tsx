                ...
                <div className="mx-auto grid max-w-7xl items-center gap-10 px-4 py-16 md:grid-cols-2 md:py-20">
                    <div>
                        ...
                        <h1 className="mt-4 font-display text-4xl font-black md:text-5xl">
                            Uniformes corporativos que representam sua marca
                        </h1>
                        <p className="mt-4 max-w-lg text-white/80">
                            Camisas, polos, calças e conjuntos com bordado,
                            grade completa de tamanhos e atendimento consultivo.
                        </p>
                    ...
                    <div className="overflow-hidden rounded-2xl border-4 border-yellow">
                        <img
                            src="/1.jpg"
                            alt="Equipe corporativa uniformizada"
                            loading="lazy"
                    ...
                    {[
                        {
                            ...
                            desc: 'Tamanhos do PP ao XGG e especiais.',
                        },
                        {
                            icon: Palette,
                            title: 'Cores e bordado',
                            desc: 'Match perfeito com sua identidade visual.',
                        },
                        {
                            icon: Package,
                            title: 'Reposição fácil',
                            desc: 'Compre novas peças quando precisar.',
                        },
                        {
                            icon: Building2,
                            title: 'Multi-departamento',
                            desc: 'Modelos diferentes por setor.',
                        },
                    ].map((f) => (
                        <div
                            key={f.title}
            ...
            <section className="bg-bg-soft py-16">
                <div className="mx-auto max-w-7xl px-4">
                    <h2 className="font-display text-3xl font-black text-navy">
                        Peças em destaque para empresas
                    </h2>
                    ...
                    <div className="mt-10 text-center">
                        <Link
                            href="/orcamento"
                            className="inline-flex items-center gap-2 rounded-md bg-navy px-6 py-3 font-bold text-white hover:bg-navy-deep"
                        >
