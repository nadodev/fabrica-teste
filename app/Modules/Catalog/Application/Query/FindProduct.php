...
final readonly class FindProduct
{
    ...
    public function handle(string $id): ?ProductView
    {
        ...
        return $product === null ? null : ProductView::fromDomain($product, $this->stock->levels($product->id->value), $this->settings->allowsOutOfStockSales(), $this->settings->lowStockWarningsEnabled());
    }
}
