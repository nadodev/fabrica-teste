...
final class StoreProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'weightGrams' => ['nullable', 'integer', 'min:1', 'max:30000'],
            'widthCentimeters' => ['nullable', 'integer', 'min:1', 'max:200'],
            'heightCentimeters' => ['nullable', 'integer', 'min:1', 'max:200'],
            'lengthCentimeters' => ['nullable', 'integer', 'min:1', 'max:200'],
